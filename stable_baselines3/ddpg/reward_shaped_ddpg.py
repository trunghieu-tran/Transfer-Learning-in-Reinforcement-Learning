...
class RewardShapedDDPG(RewardShapedTD3):
    """
    A reward-shaped version of DDPG
    ...
    def __init__(
        ...
        super(RewardShapedDDPG, self).__init__(
            policy=policy,
            env=env,
            ...
            reward_shaper=reward_shaper,            #   New
            aux_scaling_factor=aux_scaling_factor   #   New
        )
    ...
    def learn(
        ...
        return super(RewardShapedDDPG, self).learn(
